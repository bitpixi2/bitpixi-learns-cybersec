    ...
    missions: [
      {
        ...
        provider: "TAFE NSW",
        note: "Linux command line, distributions and system basics.",
        signal: "3–5 hrs · $0",
      ...
      },
      {
        ...
        provider: "TAFE NSW",
        note: "Data-centre infrastructure, operations and sustainability.",
        signal: "3–5 hrs · $0",
      ...
      },
      {
        ...
        provider: "Google",
        note: "Linux, SQL, Python, SIEM and incident-response training.",
        signal: "GUIDED PATH",
      ...
      },
      {
        ...
        note: "SY0-701 training with an exam voucher, subject to AWSN eligibility.",
        signal: "AWSN EOI",
      ...
      },
      {
        ...
        note: "Victorian IT foundation and planned prerequisite for Certificate IV.",
        signal: "PREREQUISITE",
      ...
      },
      {
        ...
        note: "Cyber operations, networking, testing and incident response.",
        signal: "VIC PATH",
    ...
    missions: [
      {
        ...
        note: "Free diagnostic across six introductory blue-team disciplines.",
        signal: "ADDED · FREE",
      ...
      },
      {
        ...
        provider: "TryHackMe",
        note: "Guided offensive and defensive browser-based security labs.",
        signal: "LAB PLATFORM",
      ...
      },
      {
        ...
        note: "Free legal web-vulnerability labs using Burp Suite.",
        signal: "FREE LABS",
      ...
      },
      {
        ...
        note: "Practical web-security credential built on Academy labs.",
        signal: "WEB PROOF",
      ...
      },
      {
        ...
        note: "Zero Trust, Entra, Defender, Sentinel and compliance basics.",
        signal: "CLOUD START",
      ...
      },
      {
        ...
        note: "Sentinel, Defender, Entra, KQL, threat hunting and automation.",
      ...
      },
      {
        ...
        provider: "CREST",
        note: "Australia/NZ pathway from theory into practical testing.",
        signal: "AU / NZ",
      ...
      },
      {
        ...
        title: "PEN-200 + OSCP+",
        provider: "OffSec",
        note: "Advanced penetration testing, reporting and problem-solving.",
        signal: "LATER GAME",
    ...
    missions: [
      {
        ...
        note: "Cloud AI guardrails, Defender security and Foundry settings.",
        signal: "PLANNED · FREE",
      ...
      },
      {
        ...
        provider: "Microsoft Applied Skills",
        note: "Connect MCP tools to Foundry agents and monitor their usage.",
        signal: "PLANNED · FREE",
      ...
      },
      {
        ...
        note: "Build enterprise agents with Foundry, MCP, RAG and APIs.",
        signal: "MAIN GOAL",
      ...
      },
      {
        ...
        note: "Lead responsible AI adoption and business-process change.",
        signal: "LEADERSHIP",
      ...
      },
      {
        ...
        note: "Gen-AI strategy, responsible adoption and Google Cloud.",
        signal: "STRATEGY",
      ...
      },
      {
        ...
        note: "Foundation models, responsible AI, security and AWS governance.",
        signal: "CLOUD AI",
      ...
      },
      {
        ...
        provider: "IAPP · AIGP",
        note: "AI lifecycle governance, risk, law, safety and trust.",
        signal: "GOVERNANCE",
